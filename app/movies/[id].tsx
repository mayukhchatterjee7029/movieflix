    ...
    return (
        <SafeAreaView className='bg-primary flex-1' >
            ...
            <ScrollView >
                ...
                <View className='flex-col items-start justify-center mt-5 mb-20 px-5'>
                    ...
                    <View className='flex-row items-center bg-dark-100 px-2 py-1 rounded-md gap-x-1'>
                        ...
                        <Text className='text-white font-bold text-sm'>{(movie?.vote_average)?.toFixed(1) ?? 0}/10</Text>
            ...
            <TouchableOpacity className='absolute bottom-5 left-0 right-0 mx-5 bg-accent opacity-[96%] rounded-lg py-3.5 flex flex-row items-center justify-center z-50' onPress={router.back} >
